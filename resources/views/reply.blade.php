  ...
  <body style="margin-top: 30px; margin-left: 200px;">
    ...
    <main class="content">
      <div class="container p-0">
        <h1 class="h3 mb-3">Ticket No #6645</h1><hr>
              ...
              <div class="chat-messages p-6">
                ...
                <div class="chat-message-left pb-4">
                  <div class="row">
                    ...
                    <div class="col-lg-8">
                    <div class="text-muted small text-nowrap mt-2"><b><strong>Admin</strong></b> {{$item->created_at}}</div>
                    {{$item->message}}
                    </div>
                   </div> 
                  </div> 
                ...
                <div class="chat-message-left pb-4">
                  <div class="row">
                    ...
                    <div class="col-lg-8">
                    <div class="text-muted small text-nowrap mt-2"><b><strong>Me</strong></b> {{$item->created_at}}</div>
                    {{$item->message}}
                    </div>
                   </div> 
                  </div> 
